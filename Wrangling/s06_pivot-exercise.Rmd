...
1. Would you say this data is in tidy format?
   ...
   <!-- Yes, every row is an observation, every column is a variable, and each cell has a value. -->
...
```{r}
(guest_long <- guest %>% 
  pivot_longer(c(starts_with("meal"), starts_with("attendance")),
